...
var KICA_MANAGEMENT_API = {
    ...
    /**
     * 인증서 삭제     
     * @param {function} callback (Result, Error) 완료 시 호출될 콜백, Result: true or false Error: 에러미시지
     * @returns {Promise} (Result, Error), Result: true or false  Error: 에러미시지
     */
...
function _disableQlalfqjsghInput() {
    var inputQlalfqjsgh = $('#qlalfqjsgh');
    inputQlalfqjsgh.prop('disabled', true);
    inputQlalfqjsgh.prop('placeholder', KICA_ERROR_MSG.CERT_PWD_DISABLED_PLACEHOLDER);
}